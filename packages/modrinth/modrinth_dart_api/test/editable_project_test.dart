...
// tests for EditableProject
void main() {
  final instance = EditableProjectBuilder();
  // TODO add properties to the builder and call build()

  group(EditableProject, () {
    ...
    test('to test the property `moderationMessage`', () async {
      // TODO
    });

    // The body of the moderators' message for the project
    // String moderationMessageBody
    test('to test the property `moderationMessageBody`', () async {
      // TODO
    });
  });
}
