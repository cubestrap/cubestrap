...
// tests for CreatableProject
void main() {
  final instance = CreatableProjectBuilder();
  // TODO add properties to the builder and call build()

  group(CreatableProject, () {
    ...
    // BuiltList<EditableVersion> initialVersions
    test('to test the property `initialVersions`', () async {
      // TODO
    });
    ...
    // BuiltList<CreatableProjectGalleryItem> galleryItems
    test('to test the property `galleryItems`', () async {
      // TODO
    });
  });
}
