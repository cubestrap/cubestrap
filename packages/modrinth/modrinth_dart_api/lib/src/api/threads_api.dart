...
class ThreadsApi {
  ...
  Future<Response<void>> deleteThreadMessage({
    required String id,
    ...
    final _path = r'/message/{id}'.replaceAll(
        '{' r'id' '}',
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<Report>>> getOpenReports({
    int? count,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  Future<Response<Report>> getReport({
    ...
    final _path = r'/report/{id}'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Thread>> getThread({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/thread/{id}'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<Thread>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<Thread>>> getThreads({
    required String ids,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    BuiltList<Thread>? _responseData;
  ...
  /// Parameters:
  /// * [id] - The ID of the report
  /// * [modifyReportRequest] - What to modify about the report
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> modifyReport({
    required String id,
    ModifyReportRequest? modifyReportRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(ModifyReportRequest);
      _bodyData = modifyReportRequest == null
          ? null
          : _serializers.serialize(modifyReportRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  /// Parameters:
  /// * [id] - The ID of the thread
  /// * [threadMessageBody] - The message to be sent. Note that you only need the fields applicable for the `text` type.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [Thread] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Thread>> sendThreadMessage({
    required String id,
    ...
    try {
      const _type = FullType(ThreadMessageBody);
      _bodyData = threadMessageBody == null
          ? null
          : _serializers.serialize(threadMessageBody, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  ///
  /// Parameters:
  /// * [creatableReport] - The report to be sent
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [Report] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Report>> submitReport({
    ...
    try {
      const _type = FullType(CreatableReport);
      _bodyData = creatableReport == null
          ? null
          : _serializers.serialize(creatableReport, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
