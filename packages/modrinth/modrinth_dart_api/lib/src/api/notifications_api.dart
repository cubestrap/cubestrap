...
class NotificationsApi {
  ...
  Future<Response<void>> deleteNotification({
    ...
    final _path = r'/notification/{id}'.replaceAll(
        '{' r'id' '}',
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteNotifications({
    required String ids,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<Notification>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<Notification>>> getUserNotifications({
    ...
    final _path = r'/user/{id|username}/notifications'.replaceAll(
        '{' r'id|username' '}',
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> readNotification({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> readNotifications({
    required String ids,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
