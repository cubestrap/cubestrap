...
class ProjectsApi {
  ...
  Future<Response<void>> addGalleryImage({
    ...
    final _path = r'/project/{id|slug}/gallery'.replaceAll(
        '{' r'id|slug' '}',
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (ordering != null)
        r'ordering':
            encodeQueryParameter(_serializers, ordering, const FullType(int)),
    };
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> changeProjectIcon({
    required String idPipeSlug,
    required String ext,
    MultipartFile? body,
    CancelToken? cancelToken,
    ...
    final _path = r'/project/{id|slug}/icon'.replaceAll(
        '{' r'id|slug' '}',
        encodeQueryParameter(_serializers, idPipeSlug, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ProjectIdentifier] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ProjectIdentifier>> checkProjectValidity({
    required String idPipeSlug,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/project/{id|slug}/check'.replaceAll(
        '{' r'id|slug' '}',
        encodeQueryParameter(_serializers, idPipeSlug, const FullType(String))
            .toString());
    final _options = Options(
    ...
    ProjectIdentifier? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ProjectIdentifier),
    ...
    return Response<ProjectIdentifier>(
      data: _responseData,
  ...
  Future<Response<Project>> createProject({
    ...
    try {
      _bodyData = FormData.fromMap(<String, dynamic>{
        r'data': encodeFormParameter(
            _serializers, data, const FullType(CreatableProject)),
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteGalleryImage({
    required String idPipeSlug,
    required String url,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  Future<Response<void>> deleteProject({
    ...
    final _path = r'/project/{id|slug}'.replaceAll(
        '{' r'id|slug' '}',
        encodeQueryParameter(_serializers, idPipeSlug, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteProjectIcon({
    required String idPipeSlug,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> followProject({
    required String idPipeSlug,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/project/{id|slug}/follow'.replaceAll(
        '{' r'id|slug' '}',
        encodeQueryParameter(_serializers, idPipeSlug, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ProjectDependencyList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ProjectDependencyList>> getDependencies({
    required String idPipeSlug,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/project/{id|slug}/dependencies'.replaceAll(
        '{' r'id|slug' '}',
        encodeQueryParameter(_serializers, idPipeSlug, const FullType(String))
            .toString());
    final _options = Options(
    ...
    ProjectDependencyList? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ProjectDependencyList),
            ) as ProjectDependencyList;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<ProjectDependencyList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<Project>>> getProjects({
    required String ids,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> modifyGalleryImage({
    required String idPipeSlug,
    required String url,
    bool? featured,
    String? title,
  ...
  /// Parameters:
  /// * [idPipeSlug] - The ID or slug of the project
  /// * [editableProject] - Modified project fields
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> modifyProject({
    required String idPipeSlug,
    ...
    try {
      const _type = FullType(EditableProject);
      _bodyData = editableProject == null
          ? null
          : _serializers.serialize(editableProject, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Parameters:
  /// * [ids] - The IDs and/or slugs of the projects
  /// * [patchProjectsBody] - Fields to edit on all projects specified
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> patchProjects({
    required String ids,
    PatchProjectsBody? patchProjectsBody,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(PatchProjectsBody);
      _bodyData = patchProjectsBody == null
          ? null
          : _serializers.serialize(patchProjectsBody, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<Project>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<Project>>> randomProjects({
    required int count,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Parameters:
  /// * [idPipeSlug] - The ID or slug of the project
  /// * [schedule] - Information about date and requested status
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> scheduleProject({
    required String idPipeSlug,
    Schedule? schedule,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/project/{id|slug}/schedule'.replaceAll(
        '{' r'id|slug' '}',
        encodeQueryParameter(_serializers, idPipeSlug, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      const _type = FullType(Schedule);
      _bodyData = schedule == null
          ? null
          : _serializers.serialize(schedule, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SearchResults>> searchProjects({
    String? query,
    String? facets,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (facets != null)
        r'facets':
            encodeQueryParameter(_serializers, facets, const FullType(String)),
      if (index != null)
        r'index':
            encodeQueryParameter(_serializers, index, const FullType(String)),
      if (offset != null)
        r'offset':
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> unfollowProject({
    required String idPipeSlug,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
